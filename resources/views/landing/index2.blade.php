    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Solusi Cerdas dengan Sistem Pakar Kami</h1>
          <h2>Jangan biarkan sistem pakar anda berakhir pada jurnal yang tidak terbaca</h2>
          <div><a href="#about" class="btn-get-started scrollto">Mulai Sekarang</a></div>
        </div>
